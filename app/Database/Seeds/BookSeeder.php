...
class BookSeeder extends Seeder
{
    public function run()
    {
        ...
        $rows = [
            ...
            // ['name'=>'তাজবীদ শিক্ষা (১-৩২)','hfb_code'=>'B22','class_name'=>'৬ষ্ঠ শ্রেণী','class_id'=>2,'slug'=>'tazbid_shikkha','price'=>75,'image' => 'uploads/books/tazbid_shikkha.jpg'],
           // ['name'=>'মুখতাছারুল আক্বীদা আল-ইসলামিইয়াহ','class_name'=>'৬ষ্ঠ শ্রেণী','class_id'=>2,'slug'=>'mukhtachul_akida','price'=>45,'image' => 'uploads/books/Shishu_math.jpg'],
            // ['name'=>'হাদীছ সংকলন','hfb_code'=>'T03','class_name'=>'৬ষ্ঠ শ্রেণী','class_id'=>2,'slug'=>'hadis_songkolon','price'=>45,'image' => 'uploads/books/hadis_songkolon.jpg'],
            // ['name'=>'সহজ আমীনুন নাহু','hfb_code'=>'T03','class_name'=>'৬ষ্ঠ শ্রেণী','class_id'=>2,'slug'=>'shohoz_aminun_nahu','price'=>00,'image' => 'uploads/books/shohoz_aminun_nahu.jpg'],

            ['name'=>'ক্লাস ডায়েরী','hfb_code'=>'CD','class_name'=>'বিভিন্ন শ্রেণীর জন্য প্রয়োজনীয় বই সমূহ','class_id'=>2,'slug'=>'class_Dairy','price'=>130,  'image' => 'uploads/books/class_Dairy.jpg'],
            ['name'=>'তাফসীরুল কুরআন (২৯ তম পারা)','hfb_code'=>'A07','class_name'=>'বিভিন্ন শ্রেণীর জন্য প্রয়োজনীয় বই সমূহ','class_id'=>2,'slug'=>'tafsirul_quran_29','price'=>300,'image' => 'uploads/books/tafsirul_quran_29.jpg'],
            ['name'=>'হাদীছ সংকলন','hfb_code'=>'B22','class_name'=>'বিভিন্ন শ্রেণীর জন্য প্রয়োজনীয় বই সমূহ','class_id'=>2,'slug'=>'hadis_songkolon_1','price'=>45,'image' => 'uploads/books/hadis_songkolon_1.jpg'],
            ['name'=>'আক্বীদা ইসলামিয়াহ','hfb_code'=>'A13','class_name'=>'বিভিন্ন শ্রেণীর জন্য প্রয়োজনীয় বই সমূহ','class_id'=>2,'slug'=>'akiday_islamiya','price'=>20,'image' => 'uploads/books/akiday_islamiya.jpg'],
            ['name'=>'তায়সীরুল আক্বীদাতিছ ছহীহাহ','hfb_code'=>'SE01','class_name'=>'বিভিন্ন শ্রেণীর জন্য প্রয়োজনীয় বই সমূহ','class_id'=>2,'slug'=>'tasirul_akidatish_shohiha','price'=>50,'image' => 'uploads/books/tasirul_akidatish_shohiha.jpg'],
            ['name'=>'আত-তাওহীদুল মুয়াসসার','hfb_code'=>'EL01','class_name'=>'বিভিন্ন শ্রেণীর জন্য প্রয়োজনীয় বই সমূহ','class_id'=>2,'slug'=>'at_tawhidul_muassara','price'=>100,'image' => 'uploads/books/at_tawhidul_muassara.jpg'],
